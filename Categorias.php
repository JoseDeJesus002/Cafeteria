...
<body onload="inicioVentana();">
	<nav>
		...
		<div class="topnav" id="responsiveNav">
			...
			<a href="#" class="Categorias" onclick="abrirCabecera('Categorias')" id="defaultOpen">Categorías</a>
	...
	<section class="bg">
		<div class="content">
		  	<h2 id="Cabecera1">Categorías</h2>
        <div class="contBoton">
					<button type="button" id="btnAgregar" onclick="location ='AgregarCategoria.php'">Agregar</button>
				</div>
				<div id="tPrincipal">
